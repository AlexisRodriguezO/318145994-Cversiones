//Rodriguez Ortiz Alexis Isaias Ejercicio Practica	4
...
//Recordando utilizar las teclas
...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::mat4(1.0);
		//Por aqui dibj la cabina
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -4.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(7.0f, 5.0f, 4.0f));
		...
		// Se inicia el dibj del brazo 
		// 
		// 
		//Articulación 1
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 2.5f, -2.5f));
		//rotación a articulación que la asocie con la cabina
		...
		//En el caso de descartar la escala no hereda la carga de la info de la matrix auxiliar 
		model = modelaux;
		//Articulación 2
		...
		// La cabina es nodo padre. Considerar a demas que la cabina y el brazo deben de estar unidos a nuestra cabina ...
		...
		//model = glm::rotate(model, glm::radians(135.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.8f, 1.5f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 1.0f, 0.8f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
